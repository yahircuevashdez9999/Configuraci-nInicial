...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelTemp = model = glm::translate(model, glm::vec3(1.5f, 0.0f, 0.0f)); //pibote
		...
		modelTemp = model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f)); //pibote
		...
		modelTemp2 = modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f)); //pibote temp2
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 1.0f));
		color = glm::vec3(1.0f, 1.0f, 1.0f); //rgb
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);//A
		...
		modelTemp = model = glm::translate(model, glm::vec3(0.4f, 0.0f, 0.0f)); //pibote
		model = glm::scale(model, glm::vec3(0.8f, 0.2f, 0.2f));
		color = glm::vec3(0.0f, 1.0f, 1.0f); //rgb
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);//A
		...
		modelTemp = model = glm::translate(model, glm::vec3(0.4f, 0.0f, 0.0f));//pibote temp2
		model = glm::scale(model, glm::vec3(0.8f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 1.0f, 1.0f); //rgb
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
